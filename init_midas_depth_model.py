...
# Is this only for 3D animation???
def init_midas_depth_model(device, generation, midas_model_type="dpt_large", optimize=True):
    midas_model = None
    net_w = None
    net_h = None
    resize_mode = None
    ...
    generation.set_status(f"Initializing MiDaS '{midas_model_type}' depth model...")
    # load network
    ...
    if midas_model_type == "dpt_large":  # DPT-Large
        ...
        generation.set_status(f"midas_model_type '{midas_model_type}' not implemented")
        assert False
    ...
    generation.set_status(f"MiDaS '{midas_model_type}' depth model initialized.")
